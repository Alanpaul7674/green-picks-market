      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/login" className="p-2 rounded-full hover:bg-accent transition-colors flex items-center">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white absolute top-full left-0 right-0 shadow-md scale-in">
          <nav className="flex flex-col py-4 px-4">
            ...
            <Link 
              to="/login" 
              className="py-3 px-4 text-sm font-medium hover:bg-accent rounded-md transition-colors flex items-center"
              onClick={() => setIsMobileMenuOpen(false)}
            >
